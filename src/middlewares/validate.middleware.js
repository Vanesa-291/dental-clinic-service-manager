...
export const validateBody = (schema) => (req, res, next) => {
  ...
  // No se sobreescribe req.body: se deja el original intacto para que
  // capas superiores (ej. la regla "no modificar el id") puedan seguir
  // inspeccionando el payload completo tal como llegó.
  next();
};
